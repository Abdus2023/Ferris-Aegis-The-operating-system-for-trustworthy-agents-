...
//!
//! ```rust,no_run
//! use ferris_aegis::{kernel::TrustKernel, agent::AgentRuntime, policy::PolicyEngine};
//!
//! #[tokio::main]
//! async fn main() -> anyhow::Result<()> {
//!     // Initialize the trust kernel
//!     let kernel = TrustKernel::new();
//!     
//!     // Load policies
//!     let policy_engine = PolicyEngine::from_file("policies/default.toml")?;
//!     
//!     // Create an agent runtime
//!     let runtime = AgentRuntime::new(kernel, policy_engine);
//!     
//!     // Spawn a trustworthy agent
//!     let agent_id = runtime.spawn("sentinel-agent", "0.1.0").await?;
